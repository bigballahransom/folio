          ...
          <div className="flex flex-col gap-10 py-10 lg:flex-row lg:flex-wrap">
            <div className="basis-1/3 flex-1 ">
              {/* <Image
                ...
                src={web1}
              /> */}
              <div className='md:mx-16 mx-6 dark:bg-gray-700 dark:shadow-none dark:border-none shadow-xl border-2 px-8 py-8 rounded-xl'>
            ...
            <div className="basis-1/3 flex-1">
              {/* <Image
                ...
                src={web3}
              /> */}
              <div className='md:mx-16 mx-6  dark:bg-gray-700 shadow-xl border-2 dark:shadow-none dark:border-none px-8 py-8 rounded-xl'>
